  ...
  return (function (e) {
    ...
    function (e, t, i) {
      ...
      !(function (r, a) {
        ...
        var o = "function",
            ...
            for (var i in t)
              if (typeof t[i] === l && t[i].length > 0) {
                for (var n = 0; n < t[i].length; n++)
                  if (V(t[i][n], e)) return "?" === i ? a : i;
              } else if (V(t[i], e)) return "?" === i ? a : i;
            return e;
          },
          W = {
            ME: "4.90",
          ...
          q = function (e, t) {
            if ((typeof e === l && ((t = e), (e = a)), !(this instanceof q)))
            ...
            return (
              ...
              (this.setUA = function (e) {
                return (
                  (i = typeof e === u && e.length > 255 ? J(e, 255) : e), this
                );
              }),
              this.setUA(i),
              this
        ...
        (q.VERSION = "0.7.30"),
          ...
          (q.CPU = F([m])),
          (q.DEVICE = F([c, f, p, g, b, w, v, y, x])),
          (q.ENGINE = q.OS = F([d, h])),
          typeof t !== s
            ? (typeof e !== s && e.exports && (t = e.exports = q),
              (t.UAParser = q))
            : i(5)
            ? (n = function () {
                return q;
    ...
    function (e, t) {
      e.exports = function () {
        ...
        this.detect = function (a) {
          var o = !1;
          for (var s in e) {
            (i.style.fontFamily = a + "," + e[s]), t.appendChild(i);
            var l = i.offsetWidth != n[e[s]] || i.offsetHeight != r[e[s]];
            t.removeChild(i), (o = o || l);
          }
          return o;
        };
      };
    ...
    function (e, t, i) {
      ...
      function u(e, t) {
        ...
        if (null != n) {
          if (t) return !0;
          for (var r = !1, o = !1, s = new Array(), u = 1; u < n.length; ++u)
          ...
          for (var c = f.getJREs(), d = 0; d < c.length; ++d)
            if (f.compareVersionToPattern(c[d], s, r, o)) return !0;
          return !1;
        }
        var p = "Invalid versionPattern passed to versionCheck: " + e;
        return l("[versionCheck()] " + p), alert(p), !1;
      }
      function c(e) {
        document.location =
          "jnlp:" +
            ...
            if (
              (function (e) {
                for (
                  ...
                  if (e.toLowerCase().startsWith(t[i])) return !0;
                return !1;
              })(e)
            )
              t = e;
      ...
      function d() {
        return (
          ...
          ("FirefoxNoPlugin" == f.browserName2 && !u("1.8*", !1)) ||
      ...
      var f = {
        ...
        launchWebStartApplication: function (e) {
          if ((this.getJPIVersionUsingMimeType(), 0 == u("1.7.0+", !1)))
            if (d()) c(e);
            else if (
        ...
        compareVersionToPattern: function (e, t, i, n) {
          ...
          if (null != a) {
            ...
            for (var f = 0; f < u; ++f) if (s[f] != t[f]) return !1;
        ...
        getBrowser: function () {
          if (null == this.browserName) {
            ...
            if (
              ...
              (this.browserName = "Edge"), (this.browserName2 = "Edge");
            else if (-1 != e.indexOf("msie") && -1 == e.indexOf("opera"))
              (this.browserName = "MSIE"), (this.browserName2 = "MSIE");
            else if (-1 != e.indexOf("trident") || -1 != e.indexOf("Trident")) {
              if (
        ...
        compareVersions: function (e, t) {
          for (var i = e.split("."), n = t.split("."), r = 0; r < i.length; ++r)
            i[r] = Number(i[r]);
          for (var a = 0; a < n.length; ++a) n[a] = Number(n[a]);
          return (
            2 == i.length && (i[2] = 0),
            i[0] > n[0] ||
              (!(i[0] < n[0]) &&
...
*/
      var i,
        ...
        M = (function () {
          var e =
              typeof m.getElementById !== l &&
              typeof m.getElementsByTagName !== l &&
              typeof m.createElement !== l,
            ...
            s = [0, 0, 0],
            p = null;
          if (typeof g.plugins !== l && typeof g.plugins[c] === u)
            (p = g.plugins[c].description) &&
              typeof g.mimeTypes !== l &&
              g.mimeTypes[d] &&
              g.mimeTypes[d].enabledPlugin &&
              ((b = !0),
              (o = !1),
              ...
              (s[2] = /[a-zA-Z]/.test(p)
                ...
                : 0));
          else if (typeof h.ActiveXObject !== l)
            try {
          ...
          return { w3: e, pv: s, wk: a, ie: o, win: n, mac: r };
        })();
      function A() {
        if (!C && document.getElementsByTagName("body")[0]) {
          ...
          C = !0;
          for (var i = v.length, n = 0; n < i; n++) v[n]();
        }
      }
      function E(e) {
        C ? e() : (v[v.length] = e);
            ...
            if (M.pv[0] > 0) {
              ...
              if (a)
                if (!G(w[t].swfVersion) || (M.wk && M.wk < 312))
                  ...
                  z(i, !0),
                    n && ((r.success = !0), (r.ref = N(i)), (r.id = i), n(r));
            } else if ((z(i, !0), n)) {
              var p = N(i);
              p &&
                typeof p.SetVariable !== l &&
                ((r.success = !0), (r.ref = p), (r.id = p.id)),
                n(r);
            }
          }
      }
      function N(e) {
        ...
        return (
          i &&
            ...
            (t =
              typeof i.SetVariable !== l
                ? i
                : i.getElementsByTagName(u)[0] || i),
          t
        );
      }
      function I() {
      ...
      function L(e) {
        var t = J("div");
        if (M.win && M.ie) t.innerHTML = e.innerHTML;
        else {
          var i = e.getElementsByTagName(u)[0];
          if (i) {
            var n = i.childNodes;
            if (n)
      ...
      function U(e, t, i) {
        var n,
          ...
          o,
          s = D(i);
        if (((i = V(i)), M.wk && M.wk < 312)) return n;
        if (s) {
          var c,
            p,
            f,
            h = M.ie ? J("div") : J(u);
          for (f in (typeof e.id === l && (e.id = i), t))
          ...
          M.ie
            ? (y[y.length] = e.id)
            : (h.setAttribute("type", d), h.setAttribute("data", e.data)),
      ...
      function q(e) {
        return null !== /[\\"<>.;]/.exec(e) && typeof encodeURIComponent !== l
          ? encodeURIComponent(e)
          : e;
      }
      M.w3 &&
        (((typeof m.readyState !== l &&
          ("complete" === m.readyState || "interactive" === m.readyState)) ||
          (typeof m.readyState === l &&
            (m.getElementsByTagName("body")[0] || m.body))) &&
          A(),
        C ||
          (typeof m.addEventListener !== l &&
            m.addEventListener("DOMContentLoaded", A, !1),
          M.ie &&
            (m.attachEvent(f, function X() {
              "complete" === m.readyState && (m.detachEvent(f, X), A());
            }),
            h == top &&
              (function $() {
                if (!C) {
            ...
            ? (function () {
                ...
                if (i) {
                  ...
                  !(function r() {
                    ...
                    else if (n < 10) return n++, void setTimeout(r, 10);
                    e.removeChild(t), (i = null), P();
                  })();
                } else P();
              })()
            : P();
        ...
        M.ie &&
          window.attachEvent("onunload", function () {
            ...
            for (var i = y.length, n = 0; n < i; n++) R(y[n]);
      ...
      var H = {
          ...
          M.w3 && !(M.wk && M.wk < 312) && e && t && i && n && r
            ? (z(p, !1),
              E(function () {
                (i += ""), (n += "");
                var h = {};
                if (c && typeof c === u) for (var m in c) h[m] = c[m];
                (h.data = e), (h.width = i), (h.height = n);
                var g = {};
                if (s && typeof s === u) for (var b in s) g[b] = s[b];
                if (o && typeof o === u)
                  for (var v in o)
                    if (Object.prototype.hasOwnProperty.call(o, v)) {
                      var w = T ? encodeURIComponent(v) : v,
                        y = T ? encodeURIComponent(o[v]) : o[v];
                      typeof g.flashvars !== l
                        ? (g.flashvars += "&" + w + "=" + y)
                        : (g.flashvars = w + "=" + y);
                    }
                if (G(r)) {
                  ...
                  if (a && I()) return (h.data = a), void B(h, g, t, d);
                  z(p, !0);
                }
                d && d(f);
              }))
        ...
        addLoadEvent: function (e) {
          if (typeof h.addEventListener !== l)
            h.addEventListener("load", e, !1);
          else if (typeof m.addEventListener !== l)
            m.addEventListener("load", e, !1);
          else if (typeof h.attachEvent !== l)
            !(function (e, t, i) {
              e.attachEvent(t, i), (x[x.length] = [e, t, i]);
            })(h, "onload", e);
        ...
        getQueryParamValue: function (e) {
          ...
          if (t) {
            if ((/\?/.test(t) && (t = t.split("?")[1]), !e)) return q(t);
        ...
        expressInstallCallback: function () {
          if (S) {
            ...
            e &&
              ...
              n && (z(n, !0), M.ie && (i.style.display = "block")),
              r && r(a)),
              (S = !1);
          }
        },
